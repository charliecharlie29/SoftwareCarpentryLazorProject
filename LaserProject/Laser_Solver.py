...
**Functions**
    ...
    save_grid
        saves a .png file of the solution if a solution is found
    *lazors_cheat*
        Goes through all possible combination of blocks for a board until a solution is found
...
**Classes**
    Block
        __init__
            contains the information for the type and coordinate of the block
        laser *function*
            tells how a laser goes when it reached each type of blocks
'''
